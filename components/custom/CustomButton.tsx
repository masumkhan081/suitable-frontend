...
export default function CustomButton({
  ...
  const styleMap = {
    ...
    authForm: `w-full text-gray-200 hover:text-gray-100 hover:bg-gray-700 border border-gray-300 rounded-md bg-purple-800 text-center px-2 py-2 font-semibold`,
  ...
  return (
    <button
      ...
      onClick={onClick}
      className={`${styleMap[styleKey]} ${disabled ? disabledStyles : ''}`}
      {...props}
    >
      {startIcon}
      {txt}
